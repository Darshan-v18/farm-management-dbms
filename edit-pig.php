...
<div class="w3-container" style="padding-top:22px">
      ...
      if(isset($_POST['submit']))
      {
      	...
      	<div class="alert alert-success alert-dismissable">
            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
             <strong>Animal details successfully update <i class="fa fa-check"></i></strong>
        </div>
       <?php
      	}else{ ?>
          <div class="alert alert-danger alert-dismissable">
            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
             <strong>Error updating  data. Please try again <i class="fa fa-times"></i></strong>
        </div>
      	<?php
      }
 ...
 <div class="col-md-4 col-md-offset-2">
 	...
 	<a class="btn btn-danger btn-md" onclick="return confirm('Continue delete pig ?')" href="delete.php?id=<?php echo $id ?>"><i class="fa fa-trash"></i> Delete animal	</a>
 </div>
</div>
</div>
</div>
