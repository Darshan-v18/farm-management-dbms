...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h5><b><i class="fa fa-dashboard"></i> Animal Management > Add</b></h5>
  </header>
 ...
 <div class="w3-row">
 	...
 	<div class="col-md-6">
      ...
      if(isset($_POST['submit']))
      {
      	...
      	$insert = $db->query("INSERT INTO pigs(animalno,animalname,weight,arrived,breed_id,remark,health_status,img,gender) VALUES('$n_animalno','$n_animalname','$n_weight','$n_arrived','$n_breed','$n_remark','$n_status','$path1','$n_gender') ");

      	if($insert){?>
      	<div class="alert alert-success alert-dismissable">
            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
             <strong>Animal successfully created <i class="fa fa-check"></i></strong>
        </div>
       <?php
      	}else{ ?>
          <div class="alert alert-danger alert-dismissable">
            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
             <strong>Error creating animal data. Please try again <i class="fa fa-times"></i></strong>
        </div>
      	<?php
      }
     ...
     ?>
 		...
 		<form method="post" autocomplete="off" enctype="multipart/form-data">
 			<div class="form-group">
	 			...
	 			<input type="text" name="animalno" class="form-control" value="ani-fms-<?php echo mt_rand(0000,9999); ?>" readonly="on" required>
	 		</div>
			 <div class="form-group">
