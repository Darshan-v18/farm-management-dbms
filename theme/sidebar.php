...
<!-- Sidebar/menu -->
<nav class="w3-sidebar w3-collapse w3-teal w3-animate-left" style="z-index:3;width:200px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="dashboard.php" class="w3-bar-item w3-button w3-padding w3-teal"><i class="fa fa-users fa-fw"></i>  Dashboard</a>
    ...
    <a href="manage-selling.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-users fa-fw"></i>  Selling Details</a>
